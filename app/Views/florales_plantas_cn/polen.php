  ...
  <div id="content">
             ...
             <div class="collapse navbar-collapse" id="navbarSupportedContent">
               <ul class="nav navbar-nav ml-auto">
                  <li class="nav-item active">
                     <a class="nav-link" href="<?= base_url() ?>\es\polen">ES</a>
                  </li>
                  <li class="nav-item">
                     <a class="nav-link" href="<?= base_url() ?>\en\bee_polen">EN</a>
                  </li>
                  <li class="nav-item">
                     <a class="nav-link" href="<?= base_url() ?>\cs\polen">簡體</a>
                  </li>
               </ul>
             </div>
          </div>
       ...
       <nav class="nav nav-underline d-md-none d-lg-none" aria-label="Secondary navigation">
           <div class="col-4 text-center">
             <a class="nav-link" href="<?= base_url() ?>\es\polen"><strong>ES</strong></a>
           </div>
           <div class="col-4 text-center">
             <a class="nav-link" href="<?= base_url() ?>\en\bee_polen"><strong>EN</strong></a>
           </div>
           <div class="col-4 text-center">
             <a class="nav-link" href="<?= base_url() ?>\cs\polen"><strong>簡體</strong></a>
           </div>
       </nav>
         ...
         <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
               <div class="carousel-item active">
                  <img class="d-block w-100" src="<?= base_url() ?>\public\assets\images\productos\florales_plantas\polen-banner-cn.png" alt="" loading="lazy">
               </div>
            </div>
         </div>
      </div>
      <div class="row mx-0">
        <div class="col-12 col-md-12 col-lg-12 text-justify">
          <h2>說明</h2>
          <p>秘魯花粉在全天然環境中培養而獲得肯定。</p>
          <p>它是一種天然有機產品，含有40％蛋白質。 它被認為是大自然中最滋養的食物之一，幾乎包含人類所需的所有營養素，包括維他命A、D、E、B1、B2、B6和鈉、鉀、鎂、鐵、銅、鋅、錳和硒等礦物質。</p>
        </div>
        <div class="col-12 col-md-12 col-lg-12 text-justify">
          <h2>益處</h2>
          <ul>
            <li>富含蛋白質、維他命和抗氧化劑</li>
            <li>具抗生素屬性</li>
            <li>促進心血管健康</li>
            <li>強化免疫力</li>
            <li>改善過敏</li>
