  ...
  <div id="content">
             ...
             <div class="collapse navbar-collapse" id="navbarSupportedContent">
               <ul class="nav navbar-nav ml-auto">
                  <li class="nav-item active">
                     <a class="nav-link" href="<?= base_url() ?>\es\pecanas">ES</a>
                  </li>
                  <li class="nav-item">
                     <a class="nav-link" href="<?= base_url() ?>\cn\pecanas">繁體</a>
                  </li>
                  <li class="nav-item">
                     <a class="nav-link" href="<?= base_url() ?>\cs\pecanas">簡體</a>
                  </li>
               </ul>
             </div>
          </div>
       ...
       <nav class="nav nav-underline d-md-none d-lg-none" aria-label="Secondary navigation">
           <div class="col-4 text-center">
             <a class="nav-link" href="<?= base_url() ?>\es\pecanas"><strong>ES</strong></a>
           </div>
           <div class="col-4 text-center">
             <a class="nav-link" href="<?= base_url() ?>\cn\pecanas"><strong>繁體</strong></a>
           </div>
           <div class="col-4 text-center">
             <a class="nav-link" href="<?= base_url() ?>\cs\pecanas"><strong>簡體</strong></a>
           </div>
       </nav>
         ...
         <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
               <div class="carousel-item active">
                  <img class="d-block w-100" src="<?= base_url() ?>\public\assets\images\productos\frutos-secos\pecanas-banner-en.png" alt="" loading="lazy">
               </div>
            </div>
         </div>
      </div>
      <div class="row mx-0">
        <div class="col-12 col-md-12 col-lg-12 text-justify">
          <h2>Description</h2>
          <p>Pecans are a rich source of energy and contain nutrients, minerals, antioxidants and vitamins that are essential for wellness.</p>
          <p>High content of Omega-6 and antioxidants.</p>
          <p>Rich in arginine, which helps hair growth.</p>
        </div>
        <div class="col-12 col-md-12 col-lg-6 text-justify">
          <h2>Health Benefits</h2>
          <p>Helps the digestive system to lose weight.</p>
          <p>Excellent source of phenolic antioxidants.</p>
          <p>Prevents coronary artery disease and strokes by favoring healthy blood lipid profile.</p>
          <p>Helps the body to remove toxins oxygen-free radicals and thus, protect the body from diseases, cancers, as well as infections.</p>
          <p>Prevents cancer diseases.</p>
          <p>Maintain the integrity of cell membrane of mucus membranes and skin by protecting it from harmful oxygen-free radicals.</p>
        </div>
          ...
          <table class="table table-bordered">
            ...
            <tbody>
              <tr>
                ...
                <td class="text-center align-middle">Vitaminic complex B</td>
              </tr>
              <tr>
                <td class="text-center align-middle">Copper</td>
                <td class="text-center align-middle">Vitamin E</td>
              </tr>
              <tr>
                <td class="text-center align-middle">Zinc</td>
                <td class="text-center align-middle">Vitamin A (betacaroteno)</td>
              </tr>
            </tbody>
          </table>
        </div>
        <div class="col-12 col-md-12 col-lg-12">
          ...
          <div class="row justify-content-center">
            <div class="col-4 col-md-4 col-lg-3">
              <img class="d-block mx-auto" src="<?= base_url() ?>\public\assets\images\presentacionesEN\FrutoSeco.png" alt="" loading="lazy">
            </div>
          </div>
        </div>
        <div class="col-12 col-md-12 col-lg-12">
