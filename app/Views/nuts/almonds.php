  ...
  <div id="content">
             ...
             <div class="collapse navbar-collapse" id="navbarSupportedContent">
               <ul class="nav navbar-nav ml-auto">
                  <li class="nav-item active">
                     <a class="nav-link" href="<?= base_url() ?>\es\almendras">ES</a>
                  </li>
                  <li class="nav-item">
                     <a class="nav-link" href="<?= base_url() ?>\cn\almendras">繁體</a>
                  </li>
                  <li class="nav-item">
                     <a class="nav-link" href="<?= base_url() ?>\cs\almendras">簡體</a>
                  </li>
               </ul>
             </div>
          </div>
       ...
       <nav class="nav nav-underline d-md-none d-lg-none" aria-label="Secondary navigation">
           <div class="col-4 text-center">
             <a class="nav-link" href="<?= base_url() ?>\es\almendras"><strong>ES</strong></a>
           </div>
           <div class="col-4 text-center">
             <a class="nav-link" href="<?= base_url() ?>\cn\almendras"><strong>繁體</strong></a>
           </div>
           <div class="col-4 text-center">
             <a class="nav-link" href="<?= base_url() ?>\cs\almendras"><strong>簡體</strong></a>
           </div>
       </nav>
         ...
         <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
               <div class="carousel-item active">
                  <img class="d-block w-100" src="<?= base_url() ?>\public\assets\images\productos\frutos-secos\almendras-banner.png" alt="" loading="lazy">
               </div>
            </div>
         </div>
      </div>
      <div class="row mx-0">
        <div class="col-12 col-md-12 col-lg-12 text-justify">
          <h2>Descripción</h2>
          <p>Las almendras son unos excelentes tentempiés, fácil de consumir, deliciosos y saludables. Pueden combinar con cualquier tipo de fruta seca o deshidratada.</p>
          <p>Son una fuente de nutrientes densa, cargados con grasas saludables, fibra y potentes antioxidantes.</p>
          <p>Las almendras ayudan a prevenir enfermedades del corazón y a luchar contra la diabetes. Pueden ayudar a reducir peso y grasa del vientre.</p>
          <p>Ingestar un puñado de almendras al día es un excelente complemento saludable a la dieta.</p>
        </div>
        <div class="col-12 col-md-12 col-lg-6 text-justify">
          <h2>Beneficios para la salud</h2>
          <p>Son una fuente de nutrientes densa, cargados con grasas saludables, fibra y potentes antioxidantes.</p>
          <ul>
            <li>Ayudan a prevenir enfermedades del corazón y a luchar contra la diabetes y colesterol.</li>
          </ul>
        </div>
          ...
          <table class="table table-bordered">
            ...
            <tbody>
              <tr>
                ...
                <td class="text-center align-middle">Vitamina B2</td>
              </tr>
              <tr>
