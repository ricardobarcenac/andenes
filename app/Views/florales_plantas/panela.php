  ...
  <div id="content">
             ...
             <div class="collapse navbar-collapse" id="navbarSupportedContent">
               <ul class="nav navbar-nav ml-auto">
                  <li class="nav-item active">
                     <a class="nav-link" href="<?= base_url() ?>\en\panela">EN</a>
                  </li>
                  <li class="nav-item">
                     <a class="nav-link" href="<?= base_url() ?>\cn\panela">繁體</a>
                  </li>
                  <li class="nav-item">
                     <a class="nav-link" href="<?= base_url() ?>\cs\panela">簡體</a>
                  </li>
               </ul>
             </div>
          </div>
       ...
       <nav class="nav nav-underline d-md-none d-lg-none" aria-label="Secondary navigation">
           <div class="col-4 text-center">
             <a class="nav-link" href="<?= base_url() ?>\en\panela"><strong>EN</strong></a>
           </div>
           <div class="col-4 text-center">
             <a class="nav-link" href="<?= base_url() ?>\cn\panela"><strong>繁體</strong></a>
           </div>
           <div class="col-4 text-center">
             <a class="nav-link" href="<?= base_url() ?>\cs\panela"><strong>簡體</strong></a>
           </div>
       </nav>
         ...
         <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
               <div class="carousel-item active">
                  <img class="d-block w-100" src="<?= base_url() ?>\public\assets\images\productos\florales_plantas\panela-banner.png" alt="" loading="lazy">
               </div>
            </div>
         </div>
      </div>
      <div class="row mx-0">
        <div class="col-12 col-md-12 col-lg-12 text-justify">
          <h2>Descripción</h2>
          <p>La panela es nutricionalmente mas baja en calorías que el azúcar de mesa, principalmente debido a la presencia de agua y minerales en su contenido (no refinada).</p>
          <p>Nuestra panela es cultivada en los andes peruanos, gozando de unas cualidades y sabor inconfundibles al paladar.</p>
        </div>
        <div class="col-12 col-md-12 col-lg-6 text-justify">
          <h2>Beneficios para la salud</h2>
          <p>Es un endulzante más saludable que el azúcar refinado, gracias a su contenido de molasas obtenidos del jugo de caña de azúcar sin refinar.</p>
          <ul>
            <li>Alto contenido de calorías.</li>
            <li>Cuida del cuero cabelludo y beneficia la exfoliación de la piel.</li>
          </ul>
        </div>
        ...
        <div class="col-12 col-md-12 col-lg-12">
          ...
          <div class="row justify-content-center">
            <div class="col-4 col-md-4 col-lg-3">
              <img class="d-block mx-auto" src="<?= base_url() ?>\public\assets\images\presentaciones\natural.png" alt="" loading="lazy">
            </div>
          </div>
        </div>
        <div class="col-12 col-md-12 col-lg-12">
