                ...
                <ul class="list-unstyled components">
                    <li>
                        ...
                        <ul class="collapse list-unstyled" id="homeSubmenu">
                            <li>
                                <a href="<?= base_url() ?>\cn\quinua">Quinua</a>
                            </li>
                            <li>
                                <a href="<?= base_url() ?>\cn\kiwicha">Kiwicha</a>
                            </li>
                            <li>
                                <a href="<?= base_url() ?>\cn\canihua">Cañihua</a>
                            </li>
                            <li>
                                <a href="<?= base_url() ?>\cn\chia">Chia</a>
                            </li>
                            <li>
                                <a href="<?= base_url() ?>\cn\sesamo">Sésamo</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                        ...
                        <ul class="collapse list-unstyled" id="homeSubmenuFrutas">
                            <li>
                                <a href="<?= base_url() ?>\cn\aguaymanto">Aguaymanto</a>
                            </li>
                            <li>
                                <a href="<?= base_url() ?>\cn\camucamu">Camu Camu</a>
                            </li>
                            <li>
                                <a href="<?= base_url() ?>\cn\acai">Acai</a>
                            </li>
                            <li>
                                <a href="<?= base_url() ?>\cn\lucuma">Lúcuma</a>
                            </li>
                            <li>
                                <a href="<?= base_url() ?>\cn\arandanos">Arándanos</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                        ...
                        <ul class="collapse list-unstyled" id="homeSubmenuCacao">
                            <li>
                                <a href="<?= base_url() ?>\cn\cacao">Cacao</a>
                            </li>
                            <li>
                                <a href="<?= base_url() ?>\cn\cafe">Café</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                        ...
                        <ul class="collapse list-unstyled" id="homeSubmenuTuberculos">
                            <li>
                                <a href="<?= base_url() ?>\cn\jengibre">Jengibre</a>
                            </li>
                            <li>
                                <a href="<?= base_url() ?>\cn\maca">Maca</a>
                            </li>
                            <li>
                                <a href="<?= base_url() ?>\cn\yacon">Yacón</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                        ...
                        <ul class="collapse list-unstyled" id="homeSubmenuFrutosSecos">
                            ...
                            <li>
                                <a href="<?= base_url() ?>\cn\pecanas">Pecanas</a>
                            </li>
                            <li>
                                <a href="<?= base_url() ?>\cn\sacha_inchi">Sacha inchi</a>
                            </li>
                            <li>
                                <a href="<?= base_url() ?>\cn\almendras">Almendras</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                        ...
                        <ul class="collapse list-unstyled" id="homeSubmenuFlorales">
                            <li>
                                <a href="<?= base_url() ?>\cn\polen">Polen</a>
                            </li>
                            <li>
                                <a href="<?= base_url() ?>\cn\miel">Miel</a>
                            </li>
                            <li>
                                <a href="<?= base_url() ?>\cn\panela">Panela</a>
                            </li>
                            <li>
                                <a href="<?= base_url() ?>\cn\andean_porcini">Andean Porcini</a>
                            </li>
                        </ul>
                    </li>
                    <li>
          ...
          <nav id="sidebar" class="d-none d-md-block d-lg-block">
              ...
              <ul class="list-unstyled components">
                  <li>
                      ...
                      <ul class="collapse list-unstyled" id="homeSubmenu">
                          <li>
                              <a href="<?= base_url() ?>\cs\quinua">藜麥</a>
                          </li>
                          <li>
                              <a href="<?= base_url() ?>\cs\kiwicha">尾穗莧</a>
                          </li>
                          <li>
                              <a href="<?= base_url() ?>\cs\canihua">小藜麥</a>
                          </li>
                          <li>
                              <a href="<?= base_url() ?>\cs\chia">奇亞籽</a>
                          </li>
                          <li>
                              <a href="<?= base_url() ?>\cs\sesamo">芝麻</a>
                          </li>
                      </ul>
                  </li>
                  <li>
                      ...
                      <ul class="collapse list-unstyled" id="homeSubmenuFrutas">
                          <li>
                              <a href="<?= base_url() ?>\cs\aguaymanto">黃金果</a>
                          </li>
                          <li>
                              <a href="<?= base_url() ?>\cs\camucamu">卡姆果</a>
                          </li>
                          <li>
                              <a href="<?= base_url() ?>\cs\acai">阿薩伊莓果</a>
                          </li>
                          <li>
                              <a href="<?= base_url() ?>\cs\lucuma">蛋黃果</a>
                          </li>
                          <li>
                              <a href="<?= base_url() ?>\cs\arandanos">藍莓</a>
                          </li>
                      </ul>
                  </li>
                  <li>
                      ...
                      <ul class="collapse list-unstyled" id="homeSubmenuCacao">
                          <li>
                              <a href="<?= base_url() ?>\cs\cacao">可可</a>
                          </li>
                          <li>
                              <a href="<?= base_url() ?>\cs\cafe">咖啡</a>
                          </li>
                      </ul>
                  </li>
                  <li>
                      ...
                      <ul class="collapse list-unstyled" id="homeSubmenuTuberculos">
                          <li>
                              <a href="<?= base_url() ?>\cs\jengibre">薑</a>
                          </li>
                          <li>
                              <a href="<?= base_url() ?>\cs\maca">瑪卡</a>
                          </li>
                          <li>
                              <a href="<?= base_url() ?>\cs\yacon">雪蓮果</a>
                          </li>
                      </ul>
                  </li>
                  <li>
                      ...
                      <ul class="collapse list-unstyled" id="homeSubmenuFrutosSecos">
                          ...
                          <li>
                              <a href="<?= base_url() ?>\cs\pecanas">胡桃</a>
                          </li>
                          <li>
                              <a href="<?= base_url() ?>\cs\sacha_inchi">印加花生果</a>
                          </li>
                          <li>
                              <a href="<?= base_url() ?>\cs\almendras">杏仁</a>
                          </li>
                      </ul>
                  </li>
                  <li>
                      ...
                      <ul class="collapse list-unstyled" id="homeSubmenuFlorales">
                          <li>
                              <a href="<?= base_url() ?>\cs\polen">花粉</a>
                          </li>
                          <li>
                              <a href="<?= base_url() ?>\cs\miel">蜂蜜</a>
                          </li>
                          <li>
                              <a href="<?= base_url() ?>\cs\panela">黑糖</a>
                          </li>
                          <li>
                              <a href="<?= base_url() ?>\cs\andean_porcini">牛肝菌</a>
                          </li>
                      </ul>
                  </li>
                  <li>
