       ...
       <div class="container text-center text-md-center text-lg-justify text-lg-left pt-4 pb-4">
          <div class="row">
             <div class="col-12 col-sm-12 col-md-12 col-lg-4 mx-auto">
                <h5 class="font-weight-bold text-uppercase mt-3 mb-2">HQ PERÚ</h5>
                <p class="mb-0"><i class="fas fa-map-marker-alt"></i> Av. Del Río 484, Prueblo Libre</p>
             ...
             <div class="col-12 col-sm-12 col-md-12 col-lg-4 mx-auto">
                <h5 class="font-weight-bold text-uppercase mt-3 mb-2">Asia Pacifico (Oficina Taiwan)</h5>
                <p class="mb-0"><i class="fas fa-map-marker-alt"></i> Rm. 7D02, No 5, Sec. 5 Xinyi Rd., Taipei City</p>
