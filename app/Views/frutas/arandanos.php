  ...
  <div id="content">
             ...
             <div class="collapse navbar-collapse" id="navbarSupportedContent">
               <ul class="nav navbar-nav ml-auto">
                  <li class="nav-item active">
                     <a class="nav-link" href="<?= base_url() ?>\en\blueberries">EN</a>
                  </li>
                  <li class="nav-item">
       ...
       <nav class="nav nav-underline d-md-none d-lg-none" aria-label="Secondary navigation">
           <div class="col-4 text-center">
             <a class="nav-link" href="<?= base_url() ?>\en\blueberries"><strong>EN</strong></a>
           </div>
           <div class="col-4 text-center">
         ...
         <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
               <div class="carousel-item active">
                  <img class="d-block w-100" src="<?= base_url() ?>\public\assets\images\productos\frutas\arandanos-banner.png" alt="" loading="lazy">
               </div>
            </div>
         </div>
      </div>
      <div class="row mx-0">
        <div class="col-12 col-md-12 col-lg-12 text-justify">
          <h2>Descripción</h2>
          <p>Los arándanos azules tienen uno de los contenidos más altos de antioxidantes entre todas las frutas, vegetales y especias. Los antioxidantes presentes en los arándanos son esenciales para mejorar la salud, combatiendo los radicales libres que dañan las estructuras celulares y el ADN.</p>
          <p>Los arándanos azules han formado parte del arte culinario de la humanidad por cientos de años, contando con una gran popularidad en todo el mundo, desde las comidas asiáticas hasta las árabes y mediterráneas.</p>
        </div>
          ...
          <table class="table table-bordered">
            ...
            <tbody>
              <tr>
                ...
                <td class="text-center align-middle">Rico en vitaminas C y K</td>
              </tr>
            </tbody>
          </table>
        </div>
