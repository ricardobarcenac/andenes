  ...
  <div id="content">
             ...
             <div class="collapse navbar-collapse" id="navbarSupportedContent">
               <ul class="nav navbar-nav ml-auto">
                  <li class="nav-item active">
                     <a class="nav-link" href="<?= base_url() ?>\en\pecans">EN</a>
                  </li>
                  <li class="nav-item">
       ...
       <nav class="nav nav-underline d-md-none d-lg-none" aria-label="Secondary navigation">
           <div class="col-4 text-center">
             <a class="nav-link" href="<?= base_url() ?>\en\pecans"><strong>EN</strong></a>
           </div>
           <div class="col-4 text-center">
         ...
         <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
               <div class="carousel-item active">
                  <img class="d-block w-100" src="<?= base_url() ?>\public\assets\images\productos\frutos-secos\pecanas-banner.png" alt="" loading="lazy">
               </div>
            </div>
         </div>
      </div>
      <div class="row mx-0">
        <div class="col-12 col-md-12 col-lg-12 text-justify">
          <h2>Descripción</h2>
          <p>Las pecanas son una fuente rica de energía, contienen 690 calorías / 100 g y contienen nutrientes, minerales, antioxidantes y vitaminas beneficiosos para la salud que son esenciales para el bienestar.</p>
          <p>Las grasas saludables de las pecanas producen cantidades ingentes de antioxidantes, reducen la inflamación y proporcionan una adición de gran sabor a cualquier plato.</p>
        </div>
        <div class="col-12 col-md-12 col-lg-6 text-justify">
          <h2>Beneficios para la salud</h2>
          <p>Alto contenido de Omega-6 y antioxidantes.</p>
          <p>Ricas en arginina, que ayuda al crecimiento del cabello.</p>
          <ul>
            <li>Ayuda al sistema digestivo y a la pérdida de peso</li>
          </ul>
        </div>
          ...
          <table class="table table-bordered">
            ...
            <tbody>
              <tr>
                ...
                <td class="text-center align-middle">Complejo vitamínico B</td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td class="text-center align-middle">Vitamina A (betacaroteno)</td>
              </tr>
            </tbody>
          </table>
        </div>
