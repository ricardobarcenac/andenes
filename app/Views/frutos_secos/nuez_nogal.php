  ...
  <div id="content">
             ...
             <div class="collapse navbar-collapse" id="navbarSupportedContent">
               <ul class="nav navbar-nav ml-auto">
                  <li class="nav-item active">
                     <a class="nav-link" href="<?= base_url() ?>\en\walnuts">EN</a>
                  </li>
                  <li class="nav-item">
                     <a class="nav-link" href="<?= base_url() ?>\cn\nuez_nogal">繁體</a>
                  </li>
                  <li class="nav-item">
       ...
       <nav class="nav nav-underline d-md-none d-lg-none" aria-label="Secondary navigation">
           <div class="col-4 text-center">
             <a class="nav-link" href="<?= base_url() ?>\en\walnuts"><strong>EN</strong></a>
           </div>
           <div class="col-4 text-center">
             <a class="nav-link" href="<?= base_url() ?>\cn\nuez_nogal"><strong>繁體</strong></a>
           </div>
           <div class="col-4 text-center">
             <a class="nav-link" href="<?= base_url() ?>\cs\nuez_nogal"><strong>簡體</strong></a>
           </div>
       </nav>
         ...
         <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
               <div class="carousel-item active">
                  <img class="d-block w-100" src="<?= base_url() ?>\public\assets\images\productos\frutos-secos\nuez_nogal-banner.png" alt="" loading="lazy">
               </div>
            </div>
         </div>
      </div>
      <div class="row mx-0">
        <div class="col-12 col-md-12 col-lg-12 text-justify">
          <h2>Descripción</h2>
          <p>Las nueces de nogal siempre han sido consideradas como “comida para el cerebro”. Estudios recientes han demostrado que el consumo de nueces de nogal ayuda al buen funcionamiento del cerebro.</p>
          <p>Las nueces de nogal son ricas en acidos grasos beneficiosos para la salud, particularmente el Omega-6 que ayuda a combatir el colesterol. Asimismo, son reconocidas por su contenido de complejo vitamínico B, que ayudan a combatir la fatiga y potencian la actividad física.</p>
        </div>
        <div class="col-12 col-md-12 col-lg-6 text-justify">
          <h2>Beneficios para la salud</h2>
          <p>Fuente de salud para el cerebro, gracias a su alto contenido de Omega-6 y complejo vitamínico B.</p>
          <ul>
            <li>Ayuda a mejorar la actividad cerebral</li>
            <li>Combate el colesterol y ayuda a mantener la salud cardiovascular</li>
          </ul>
        </div>
          ...
          <table class="table table-bordered">
            ...
            <tbody>
              <tr>
                ...
                <td class="text-center align-middle">Complejo vitamínico B (B1, B2, B3, B5, B6 y B9)</td>
              </tr>
              <tr>
                <td class="text-center align-middle">Magnesio</td>
                <td class="text-center align-middle">Pequeñas cantidades de vitaminas C, E y K</td>
              </tr>
              <tr>
