  ...
  <div id="content">
             ...
             <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="nav navbar-nav ml-auto">
                   <li class="nav-item active">
                      <a class="nav-link" href="<?= base_url() ?>\es\kiwicha">ES</a>
                   </li>
                   <li class="nav-item">
                      <a class="nav-link" href="<?= base_url() ?>\cn\kiwicha">繁體</a>
                   </li>
                   <li class="nav-item">
                      <a class="nav-link" href="<?= base_url() ?>\cs\kiwicha">簡體</a>
                   </li>
                </ul>
             </div>
          </div>
       ...
       <nav class="nav nav-underline d-md-none d-lg-none" aria-label="Secondary navigation">
           <div class="col-4 text-center">
             <a class="nav-link" href="<?= base_url() ?>\es\kiwicha"><strong>ES</strong></a>
           </div>
           <div class="col-4 text-center">
             <a class="nav-link" href="<?= base_url() ?>\cn\kiwicha"><strong>繁體</strong></a>
           </div>
           <div class="col-4 text-center">
             <a class="nav-link" href="<?= base_url() ?>\cs\kiwicha"><strong>簡體</strong></a>
           </div>
       </nav>
         ...
         <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
               <div class="carousel-item active">
                  <img class="d-block w-100" src="<?= base_url() ?>\public\assets\images\productos\granos_semillas\kiwicha-banner-en.png" alt="" loading="lazy">
               </div>
            </div>
         </div>
      </div>
      <div class="row mx-0">
        <div class="col-12 col-md-12 col-lg-12 text-justify">
          ...
          <p>Contains essential aminoacids, with remarkable lysine quantites.</p>
        </div>
          ...
          <table class="table table-bordered">
            ...
            <tbody>
              <tr>
                ...
                <td class="text-center align-middle">Vitaminic complex B (B2, B3, B5, B6 y B9 or folic acid)</td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td class="text-center align-middle">Vitamin C</td>
              </tr>
              <tr>
