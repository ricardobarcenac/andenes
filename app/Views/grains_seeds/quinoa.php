  ...
  <div id="content">
             ...
             <div class="collapse navbar-collapse" id="navbarSupportedContent">
               <ul class="nav navbar-nav ml-auto">
                  <li class="nav-item active">
                     <a class="nav-link" href="<?= base_url() ?>\es\quinua">ES</a>
                  </li>
                  <li class="nav-item">
       ...
       <nav class="nav nav-underline d-md-none d-lg-none" aria-label="Secondary navigation">
           <div class="col-4 text-center">
             <a class="nav-link" href="<?= base_url() ?>\es\quinua"><strong>ES</strong></a>
           </div>
           <div class="col-4 text-center">
         ...
         <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
               <div class="carousel-item active">
                  <img class="d-block w-100" src="<?= base_url() ?>\public\assets\images\productos\granos_semillas\quinua-banner-en.png" alt="" loading="lazy">
               </div>
            </div>
         </div>
      </div>
      <div class="row mx-0">
        <div class="col-12 col-md-12 col-lg-12 text-justify">
          <h2>Description</h2>
          <p>Contains all the essential aminoacids for the human body including: lysine, methionine and histidine.</p>
          <p>A stunning 12% of protein, more than other cereal.</p>
        </div>
          ...
          <table class="table table-bordered">
            ...
            <tbody>
              <tr>
                ...
                <td class="text-center align-middle">Vitaminic complex B (B1, B2, B3 y B6)</td>
              </tr>
              <tr>
                <td class="text-center align-middle">Magnesium</td>
                <td class="text-center align-middle">Vitamin E</td>
              </tr>
              <tr>
                <td class="text-center align-middle">Fosforo</td>
