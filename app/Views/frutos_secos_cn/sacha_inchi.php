  ...
  <div id="content">
             ...
             <div class="collapse navbar-collapse" id="navbarSupportedContent">
               <ul class="nav navbar-nav ml-auto">
                  <li class="nav-item active">
                     <a class="nav-link" href="<?= base_url() ?>\es\sacha_inchi">ES</a>
                  </li>
                  <li class="nav-item">
       ...
       <nav class="nav nav-underline d-md-none d-lg-none" aria-label="Secondary navigation">
           <div class="col-4 text-center">
             <a class="nav-link" href="<?= base_url() ?>\es\sacha_inchi"><strong>ES</strong></a>
           </div>
           <div class="col-4 text-center">
         ...
         <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
               <div class="carousel-item active">
                  <img class="d-block w-100" src="<?= base_url() ?>\public\assets\images\productos\frutos-secos\sachainchi-banner-cn.png" alt="" loading="lazy">
               </div>
            </div>
         </div>
      </div>
      <div class="row mx-0">
        <div class="col-12 col-md-12 col-lg-12 text-justify">
          <h2>說明</h2>
          <p>與世界上的種籽油相比，印加花生果被認為是世界上最健康的食用種子，因為富含不飽和脂肪酸。</p>
          <p>它是一種高品質的食品級健康油。 它是家庭、工業、化妝品、藥用級的最佳油品，優於目前市面上使用的油，如橄欖油、葵花油、大豆油、玉米油、棕櫚油、花生油等。</p>
          <p>它有利於神經系統和促進大腦發育正常，因為它含有豐富的必需脂肪酸，如Omega 3，Omega 6和Omega 9。</p>
        </div>
        <div class="col-12 col-md-12 col-lg-6 text-justify">
          <h2>益處</h2>
          <ul>
            <li>有助於抵抗與腸燥症和肝臟相關的問題。</li>
            <li>有益於減少血液中的不良膽固醇（LDL），並刺激良好膽固醇（HDL）的增加。</li>
            <li>調節動脈血壓，預防動脈血栓形成和心肌梗塞。</li>
            <li>減少三酸甘油酯，改善血液循環。</li>
          </ul>
        </div>
        <div class="col-12 col-md-12 col-lg-6">
          <table class="table table-bordered">
            ...
            <tbody>
              <tr>
                <td class="text-center align-middle">钼</td>
                <td class="text-center align-middle">β-胡蘿蔔素</td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td class="text-center align-middle">維他命E</td>
              </tr>
              <tr>
                <td class="text-center align-middle">镁</td>
        ...
        <div class="col-12 col-md-12 col-lg-12">
          ...
          <div class="row justify-content-center">
            <div class="col-4 col-md-4 col-lg-3">
              <img class="d-block mx-auto" src="<?= base_url() ?>\public\assets\images\presentacionesCN\FrutoSeco.png" alt="" loading="lazy">
            </div>
            <div class="col-4 col-md-4 col-lg-3">
              <img class="d-block mx-auto" src="<?= base_url() ?>\public\assets\images\presentacionesCN\aceite.png" alt="" loading="lazy">
            </div>
            <div class="col-4 col-md-4 col-lg-3">
