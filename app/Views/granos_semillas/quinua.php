  ...
  <div id="content">
             ...
             <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="nav navbar-nav ml-auto">
                   <li class="nav-item active">
                      <a class="nav-link" href="<?= base_url() ?>\en\quinoa">EN</a>
                   </li>
                   <li class="nav-item">
                      <a class="nav-link" href="<?= base_url() ?>\cn\quinua">繁體</a>
                   </li>
                   <li class="nav-item">
                      <a class="nav-link" href="<?= base_url() ?>\cs\quinua">簡體</a>
                   </li>
                </ul>
             </div>
          </div>
       ...
       <nav class="nav nav-underline d-md-none d-lg-none" aria-label="Secondary navigation">
           <div class="col-4 text-center">
             <a class="nav-link" href="<?= base_url() ?>\en\quinoa"><strong>EN</strong></a>
           </div>
           <div class="col-4 text-center">
             <a class="nav-link" href="<?= base_url() ?>\cn\quinua"><strong>繁體</strong></a>
           </div>
           <div class="col-4 text-center">
             <a class="nav-link" href="<?= base_url() ?>\cs\quinua"><strong>簡體</strong></a>
           </div>
       </nav>
         ...
         <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
               <div class="carousel-item active">
                  <img class="d-block w-100" src="<?= base_url() ?>\public\assets\images\productos\granos_semillas\quinua\quinua-banner.png" alt="" loading="lazy">
               </div>
            </div>
         </div>
      </div>
      <div class="row mx-0">
        <div class="col-12 col-md-12 col-lg-12 text-justify">
          <h2>Descripción</h2>
          <p>La quinua es un producto milenario cultivado en los Andes desde mucho antes de la civilización Inca. Es un super alimento reconocido en el
            mundo por su alto valor nutricional: rico en proteínas de alta calidad (proteínas de fácil absorción para el organismo y con todos los
            aminoácidos esenciales), grasa insaturada y minerales.</p>
        </div>
        <div class="col-12 col-md-12 col-lg-6 text-justify">
          <h2>Beneficios para la salud</h2>
          <p>Tiene todos los aminoácidos esenciales para el cuerpo humano, incluyendo: lisina, metionina e histidina.</p>
          <p>12% de proteína, más que cualquier otro cereal.</p>
          <ul>
            <li>Sin Gluten</li>
            <li>Fuente de fibra dietética y proteína de altísima calidad</li>
          </ul>
        </div>
        <div class="col-12 col-md-12 col-lg-6">
          <table class="table table-bordered">
            ...
            <tbody>
              <tr>
                <td class="text-center align-middle">Manganeso</td>
                <td class="text-center align-middle">Complejo vitaminico B (B1, B2, B3 y B6)</td>
              </tr>
              <tr>
        ...
        <div class="col-12 col-md-12 col-lg-12">
          ...
          <div class="row justify-content-center">
            ...
            <div class="col-4 col-md-4 col-lg-3">
              <img class="d-block mx-auto" src="<?= base_url() ?>\public\assets\images\presentaciones\harina.png" alt="" loading="lazy">
            </div>
            <div class="col-4 col-md-4 col-lg-3">
              <img class="d-block mx-auto" src="<?= base_url() ?>\public\assets\images\presentaciones\hojuelas.png" alt="" loading="lazy">
            </div>
            <div class="col-4 col-md-4 col-lg-3">
              <img class="d-block mx-auto" src="<?= base_url() ?>\public\assets\images\presentaciones\polvo.png" alt="" loading="lazy">
            </div>
            <div class="col-4 col-md-4 col-lg-3">
              <img class="d-block mx-auto" src="<?= base_url() ?>\public\assets\images\presentaciones\pop.png" alt="" loading="lazy">
            </div>
            <div class="col-4 col-md-4 col-lg-3">
              <img class="d-block mx-auto" src="<?= base_url() ?>\public\assets\images\presentaciones\precocida.png" alt="" loading="lazy">
            </div>
            <div class="col-4 col-md-4 col-lg-3">
