  ...
  <div id="content">
       <nav class="navbar navbar-expand-lg navbar-light bg-light d-none d-md-block d-lg-block">
             ...
             <div class="collapse navbar-collapse" id="navbarSupportedContent">
               <ul class="nav navbar-nav ml-auto">
                  <li class="nav-item active">
                     <a class="nav-link" href="<?= base_url() ?>\en\chia">EN</a>
                  </li>
                  <li class="nav-item">
                     <a class="nav-link" href="<?= base_url() ?>\cn\chia">繁體</a>
                  </li>
                  <li class="nav-item">
                     <a class="nav-link" href="<?= base_url() ?>\cs\chia">簡體</a>
                  </li>
               </ul>
             </div>
          </div>
          <nav class="nav nav-underline d-md-none d-lg-none" aria-label="Secondary navigation">
              <div class="col-4 text-center">
                <a class="nav-link" href="<?= base_url() ?>\en\chia"><strong>EN</strong></a>
              </div>
              <div class="col-4 text-center">
                <a class="nav-link" href="<?= base_url() ?>\cn\chia"><strong>繁體</strong></a>
              </div>
              <div class="col-4 text-center">
                <a class="nav-link" href="<?= base_url() ?>\cs\chia"><strong>簡體</strong></a>
              </div>
          </nav>
       </nav>
         ...
         <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
               <div class="carousel-item active">
                  <img class="d-block w-100" src="<?= base_url() ?>\public\assets\images\productos\granos_semillas\chia\chia-banner.png" alt="" loading="lazy">
               </div>
            </div>
         </div>
      </div>
      <div class="row mx-0">
        <div class="col-12 col-md-12 col-lg-12 text-justify">
          <h2>Descripción</h2>
          <p>La chía es una semilla ancestral originaria de Latinoamérica. En las civilizaciones pre-hispánicas de Centroamérica las semillas de chía fueron alimento, medicina, ofrenda divina e incluso fueron usadas como un método de pago comercial y tributario.</p>
        </div>
        <div class="col-12 col-md-12 col-lg-6 text-justify">
          <h2>Beneficios para la salud</h2>
          <p>Fibra dietética útil para mejorar el sistema digestivo y pérdida peso.</p>
          <p>Rica en ácidos grasos Omega 3 y Omega 6.</p>
          <ul>
            <li>Ayuda al sistema digestivo y al sistema cardiovascular</li>
            <li>Ayuda a bajar el colesterol</li>
          </ul>
        </div>
          ...
          <table class="table table-bordered">
            ...
            <tbody>
              <tr>
                ...
                <td class="text-center align-middle">Omega 3</td>
              </tr>
              <tr>
                <td class="text-center align-middle">Fósforo</td>
                <td class="text-center align-middle">Omega 6</td>
              </tr>
              <tr>
        ...
        <div class="col-12 col-md-12 col-lg-12">
          ...
          <div class="row justify-content-center">
            <div class="col-4 col-md-4 col-lg-3">
              <img class="d-block mx-auto" src="<?= base_url() ?>\public\assets\images\presentaciones\semilla.png" alt="" loading="lazy">
            </div>
            <div class="col-4 col-md-4 col-lg-3">
