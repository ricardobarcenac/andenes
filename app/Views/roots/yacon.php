  ...
  <div id="content">
             ...
             <div class="collapse navbar-collapse" id="navbarSupportedContent">
               <ul class="nav navbar-nav ml-auto">
                  <li class="nav-item active">
                     <a class="nav-link" href="<?= base_url() ?>\es\yacon">ES</a>
                  </li>
                  <li class="nav-item">
       ...
       <nav class="nav nav-underline d-md-none d-lg-none" aria-label="Secondary navigation">
           <div class="col-4 text-center">
             <a class="nav-link" href="<?= base_url() ?>\es\yacon"><strong>ES</strong></a>
           </div>
           <div class="col-4 text-center">
         ...
         <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
               <div class="carousel-item active">
                  <img class="d-block w-100" src="<?= base_url() ?>\public\assets\images\productos\tuberculos\yacon-banner-en.png" alt="" loading="lazy">
               </div>
            </div>
         </div>
      </div>
      <div class="row mx-0">
        <div class="col-12 col-md-12 col-lg-12 text-justify">
          <h2>Description</h2>
          <p>Yacon is the richest source of fructooligosaccharides which help regulate the digestive system, with a low chalorical levels.</p>
          <p>Our Yacon is cultivated in amazonas Cajamarca, San Martín, Huánaco, Pasco, Apurímac, Cusco and Puno.</p>
          <p>Yacon is an ideal food for people who suffer from diabetes and those who want to lose weight. It is known to be rich in dietary fiber and low in calories.</p>
        </div>
        <div class="col-12 col-md-12 col-lg-6 text-justify">
          <h2>Health Benefits</h2>
          <p>Reduce diabetes risk and helps controlling it.</p>
          <p>Helps lose weight (great sugar replacement).</p>
          <p>Excellent for hypo caloric diets and for diabetic patients.</p>
          <p>Anti-diabetic attributes.</p>
          <p>Reduces risk of osteoporosis.</p>
          <p>No-calorie sweetener.</p>
          <p>Reduces triglycerides levels in blood.</p>
          <p>Relieves gastrointestinal problems.</p>
        </div>
        <div class="col-12 col-md-12 col-lg-6">
          <table class="table table-bordered">
            ...
            <tbody>
              <tr>
                <td class="text-center align-middle">Potassium</td>
              </tr>
              <tr>
        ...
        <div class="col-12 col-md-12 col-lg-12">
          ...
          <div class="row justify-content-center">
            ...
            <div class="col-4 col-md-4 col-lg-3">
              <img class="d-block mx-auto" src="<?= base_url() ?>\public\assets\images\presentacionesEN\rodajas.png" alt="" loading="lazy">
            </div>
            <div class="col-4 col-md-4 col-lg-3">
              <img class="d-block mx-auto" src="<?= base_url() ?>\public\assets\images\presentacionesEN\trozos.png" alt="" loading="lazy">
            </div>
          </div>
        </div>
        <div class="col-12 col-md-12 col-lg-12">
