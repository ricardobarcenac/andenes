      ...
      <div class="col-12">
        <div class="row justify-content-center py-5">
          <div class="col-12 col-md-8 col-lg-8">
            <h2>Contact us!</h2>
            <form action="contacto_en" method="post">
              <div class="form-group">
                <input type="text" class="form-control" id="nombres" name="nombres" placeholder="Names" required>
              </div>
              <div class="form-group">
                <input type="text" class="form-control" id="telefono" name="telefono" placeholder="Phone" required>
              </div>
              <div class="form-group">
                <input type="mail" class="form-control" id="correo" name="correo" placeholder="Email">
              </div>
              <!--<div class="form-group">
              ...
              <div class="form-group">
                <textarea class="form-control" id="consulta" name="consulta" cols="40" rows="10" placeholder="Message" style="min-height: 200px"></textarea>
              </div>
              <p class="text-center">Al enviar este formulario, usted acepta nuestros <a href="#">Términos y Condiciones</a></p>
              <div class="form-group text-center">
                <button type="submit" class="btn btn-success rounded-0 px-5 py-2" href="#" role="button"><i class="far fa-envelope"></i><small> ¡CONTACT ME!</small></button>
              </div>
            </form>
          </div>
        </div>
