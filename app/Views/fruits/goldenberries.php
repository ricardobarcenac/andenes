  ...
  <div id="content">
         ...
         <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
               <div class="carousel-item active">
                  <img class="d-block w-100" src="<?= base_url() ?>\public\assets\images\productos\frutas\aguaymanto-banner-en.png" alt="" loading="lazy">
               </div>
            </div>
         </div>
      </div>
      <div class="row mx-0">
        <div class="col-12 col-md-12 col-lg-12 text-justify">
          <h2>Description</h2>
          <p>Originally from Peru, its a powerful antioxidant, with a high content of vitamins and minerals (calcium, phosphorous, potasium and iron).</p>
          <p>It’s a perfect food to strengthen human immune system and ideal to treat asthmatic conditions, sinusitis and other allergies.</p>
        </div>
        <div class="col-12 col-md-12 col-lg-6 text-justify">
          <h2>Health Benefits</h2>
          <p>Strengthens human immune system.</p>
          <p>Eases asthmatic treatment conditions.</p>
          <p>Allieviates sinusitis and other allergies.</p>
          <p>Goldenberries naturally boost red blood cells and increase cardiovascular proper functioning.</p>
          ...
          <table class="table table-bordered">
            ...
            <tbody>
              <tr>
                ...
                <td class="text-center align-middle">Rich en vitamins A, C, E y K</td>
              </tr>
              <tr>
